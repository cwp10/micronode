...
class tcpServer {
  ...
  connectToDistributor (host, port, onNoti) {
    ...
    this.clientDistributor = new tcpClient(
      ...
      , (option, data) => {onNoti(data)}                  // Distributor 데이터 수신 이벤트
      , (option) => {isConnectedDistributor = false}      // Distributor 접속종료 이벤트
      , (option) => {isConnectedDistributor = false}      // Distributor 통신 에러 이벤트
    )
